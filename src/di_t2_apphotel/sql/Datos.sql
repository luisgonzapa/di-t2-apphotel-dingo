...
INSERT INTO CLIENTE VALUES ('25142741L','Pedro Montañez','C/Panamá Nº15','Alcobendas',1);
INSERT INTO CLIENTE VALUES ('12345678Q','Andrea Pirlo','C/Marina Nº16','Badalona',8);
...
CREATE TABLE RESERVAS_SALON(
    ...
    TIPO_COCINA VARCHAR(40) CONSTRAINT TIPO_COCINA_CK CHECK(TIPO_COCINA IN('No precisa', 'Bufé vegetariano', 'Bufé normal', 'Carta', 'Pedir cita con chef')),
    FECHA DATE NOT NULL,
    NUM_HABITACIONES INTEGER,
    NUM_DIAS INTEGER,
